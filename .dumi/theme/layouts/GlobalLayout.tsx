    ...
    <Provider
      ...
      getMessages={(intl) => ({
        ...
        ANNOUNCEMENT: [
          ...
          {
            title: 'OpenSPG',
            desc: intl('OpenSPG 开源发布', 'OpenSPG Open Source Release'),
        ...
        TECHNICAL_FEATURES: [
          {
            ...
            img: 'https://mdn.alipayobjects.com/huamei_xgb3qj/afts/img/A*88JoRLde504AAAAAAAAAAAAADtmcAQ/original',
          },
          {
            title: intl(
              '深度语义上下文关联',
